    ...
    <nav class="nav">
        <div class="nav-link-logo"> 
            ...
            <div class="nav_list">
                ...
                <a data-bs-toggle="tooltip" data-bs-placement="right" title="Alunos" id="nav-link-alunos" style="cursor:pointer;" onclick="redirect('alunos.php')" class="nav_link"> <i class='bx bxs-graduation nav_icon'></i> <span class="nav_name">Alunos</span> </a> 
                ...
                <a data-bs-toggle="tooltip" data-bs-placement="right" title="Presenças" id="nav-link-alunos" style="cursor:pointer;" onclick="redirect('presencas.php')" class="nav_link"> <i class='bx bx-list-check nav_icon'></i> <span class="nav_name">Presenças</span> </a> 
